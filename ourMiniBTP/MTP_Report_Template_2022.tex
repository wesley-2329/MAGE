...
%\input{FrontPages/title_page.tex}
%\thispagestyle{empty}
%\clearpage
...
\input{FrontPages/Declaration.tex}
...
\input{chapters/Introduction/Introduction.tex}\label{chap:intro}


\chapter{Literature Review}
\vspace{-1cm}
\noindent \rule{6.6in}{0.01in}
\emph{This chapter reviews the literature on machine-generated text detection. It explores traditional lexical n-gram baselines, deep contextual transformer models, zero-shot token predictability measures, and the out-of-distribution (OOD) open-set rejection problem. By analyzing the vulnerabilities of existing systems under distribution shifts, the chapter establishes the theoretical foundation for our proposed Stage-2 open-set rejection framework.}
\input{chapters/Literature_Review/Literature_Review.tex}\label{chap:L_survey}
...
\input{chapters/Methodology/Methodology.tex}\label{chap:problem_statement}
...
\input{chapters/Experiments and Results/Experiments and Results.tex}\label{chap:results}
...
\input{chapters/Conclusion and Future Scopes/conclusions_futurescope.tex}\label{chap:conclusion and future scopes}
